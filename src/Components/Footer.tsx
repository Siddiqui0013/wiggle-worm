...
export default function Footer() {
  return (
         <div className="w-full mt-80 my:20 mx-auto relative flex items-center my-8 justify-center">
            <div className="box z-10 md:bg-[#228B22] bg-[#4E342E] md:w-[85%] w-[95%] rounded-2xl border-[#4E342E] border-[12px] md:p-16">
              <div className="flex flex-col gap-8 items-center justify-center py-16 text-center bg-[#FFF9C4] rounded-2xl border-[#4E342E] border-4">
                ...
                <div className="flex md:gap-4 gap-1 mb- items-center">
            ...
            <img src={snake} className="absolute w-[200px] md:w-[300px] -top-72 -scale-x-[1] left-40" alt="" />
        </div>
  )
}
